...
class CCCore_hip(Core):
    ...
    def getAction(self, actionParam, state):
        ...
        mot_lumbar_extension = actionParam[self.action_index['mot_lumbar_extension']]
        ...
        mot_hip_flexion_r = self.calculate_hip_flexion(actionParam, state, GRF_z_r, 0)
        mot_hip_flexion_l = self.calculate_hip_flexion(actionParam, state, GRF_z_l, 1)
        ...
        mot_knee_angle_r = actionParam[self.action_index['mot_knee_angle_r']]
        mot_knee_angle_l = actionParam[self.action_index['mot_knee_angle_l']]
        mot_ankle_angle_r = actionParam[self.action_index['mot_ankle_angle_r']]
        mot_ankle_angle_l = actionParam[self.action_index['mot_ankle_angle_l']]
