...
#         else:
#             xml_path = (Path(__file__).resolve().parent.parent / "data" / "humanoid" /
#                         "humanoid_torque_lumbar.xml").as_posix()
#
...
#
#         super().__init__(xml_handle, action_spec, observation_spec, collision_groups, use_foot_forces=True, **kwargs)
#
